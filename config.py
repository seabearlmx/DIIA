...
__C.DATASET.CITYSCAPES_DIR = './datasets/Cityscapes'
#SDC Augmented Cityscapes Dir Location
__C.DATASET.CITYSCAPES_AUG_DIR = ''
#Mapillary Dataset Dir Location
__C.DATASET.MAPILLARY_DIR = './datasets/mapillary'
#GTAV, BDD100K Dataset Dir Location
__C.DATASET.GTAV_DIR = './datasets/GTA5'
__C.DATASET.BDD_DIR = './datasets/bdd-100k'
#Synthia Dataset Dir Location
__C.DATASET.SYNTHIA_DIR = './datasets/SYNTHIA_SPLIT'
...
__C.DATASET.CAMVID_DIR = './SegNet-Tutorial/CamVid'
